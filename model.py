...
x.drop(['sales','Emp_Collaborative','Emp_Work_Status','GEO','Role','Department','Will_Relocate','Gender','promotion_last_5years','EMP_Sat_Remote','LinkedIn_Hits','Emp_Competitive','Work_accident','salary','Emp_Position','Emp_Title', 'Emp_Identity'], axis=1, inplace=True)
